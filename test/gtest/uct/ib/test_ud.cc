...
UCS_TEST_P(test_ud, skb_pending_free_gc)
{
    ...
    /* Fire a delayed synthetic hardware completion that updates comp_sn to 25
   */
   ...
   * freed). */
    ...
    /* Fire a final hardware completion to 30 and verify the queue completely
   * drains. */
